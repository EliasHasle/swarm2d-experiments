function SwarmMaterial(frontColor, backColor, pointRadius) {
...
function Swarm({number, frontColor, backColor, pointRadius, initProc, updateProc}) {
	this.number = number;
	...
	if (typeof initProc !== "undefined")
		initProc(this.positions, this.velocities, this.inFront, this.userData);
	
	posAttr.needsUpdate = true;
	inFrontAttr.needsUpdate = true;
	
	let material = new SwarmMaterial(frontColor, backColor, pointRadius);
...
Object.assign(Swarm.prototype, {
	...
	update: function(t, dt) {
		...
		this.updateProc(this.positions, this.velocities, this.inFront, t, dt); //Important!
